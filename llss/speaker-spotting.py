...
def process_score(scores):
    '''
    Store the score and time where the score higher than all previous scores
    '''
    min_score = -1
    res = []
...
if __name__ == '__main__':
    ...
    #compute enrollment representation
    models = {}
    ...
    # speaker spotting based on oracle diarization
    if arguments['oracle']:
        REFERENCE = {}
    ...
    # speaker spotting based on automatic diarization
    ...
    # speaker spotting based on segmental diarization
    if arguments['segmental']:
